...
export default class App extends Component {
  ...
  startScreenShare(windowId=0, captureFreq=15, 
    ...
    return new Promise((resolve, reject) => {
      ...
      rtcEngine.videoSourceStartScreenCaptureByWindow(windowId, {x: 0, y: 0, width: 0, height: 0}, {width: 0, height: 0, bitrate: 500, frameRate: 15, excludeWindowList: [], captureMouseCursor:false, windowFocus: false})
  ...
  startScreenShareByDisplay(displayId) {
    ...
    return new Promise((resolve, reject) => {
      ...
      rtcEngine.videoSourceStartScreenCaptureByScreen(displayId, {x: 0, y: 0, width: 0, height: 0}, {width: 0, height: 0, bitrate: 500, frameRate: 5, excludeWindowList:[], captureMouseCursor:false, windowFocus: false})
      rtcEngine.startScreenCapturePreview();
    });
  }
