...
public:
			...
			virtual bool setBoolParameters(const char* param, bool value) = 0;
			virtual bool setStringParameters(const char* param, const char* value) = 0;
...
extern "C" __declspec(dllexport) IAudioFramePlugin* createAudioFramePlugin();
