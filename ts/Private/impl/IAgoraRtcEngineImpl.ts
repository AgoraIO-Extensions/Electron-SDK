...
size,
  ...
  protected getApiTypeFromStartEchoTest (intervalInSeconds: number = 10): string {
  ...
  startAudioMixing (filePath: string, loopback: boolean, cycle: number, startPos: number = 0): number {
  ...
  protected getApiTypeFromStartAudioMixing (filePath: string, loopback: boolean, cycle: number, startPos: number = 0): string {
  ...
  preloadEffect (soundId: number, filePath: string, startPos: number = 0): number {
  ...
  protected getApiTypeFromPreloadEffect (soundId: number, filePath: string, startPos: number = 0): string {
    return 'RtcEngine_preloadEffect'
  }

  playEffect (soundId: number, filePath: string, loopCount: number, pitch: number, pan: number, gain: number, publish: boolean = false, startPos: number = 0): number {
  ...
  protected getApiTypeFromPlayEffect (soundId: number, filePath: string, loopCount: number, pitch: number, pan: number, gain: number, publish: boolean = false, startPos: number = 0): string {
    return 'RtcEngine_playEffect'
  }

  playAllEffects (loopCount: number, pitch: number, pan: number, gain: number, publish: boolean = false): number {
  ...
  protected getApiTypeFromPlayAllEffects (loopCount: number, pitch: number, pan: number, gain: number, publish: boolean = false): string {
  ...
  protected getApiTypeFromEnableAudioSpectrumMonitor (intervalInMS: number = 100): string {
  ...
  protected getApiTypeFromLoadExtensionProvider (path: string, unloadAfterUse: boolean = false): string {
  ...
  registerExtension (provider: string, extension: string, type: MediaSourceType = MediaSourceType.UnknownMediaSource): number {
  ...
  protected getApiTypeFromRegisterExtension (provider: string, extension: string, type: MediaSourceType = MediaSourceType.UnknownMediaSource): string {
    return 'RtcEngine_registerExtension'
  }

  enableExtension (provider: string, extension: string, enable: boolean = true, type: MediaSourceType = MediaSourceType.UnknownMediaSource): number {
  ...
  protected getApiTypeFromEnableExtension (provider: string, extension: string, enable: boolean = true, type: MediaSourceType = MediaSourceType.UnknownMediaSource): string {
  ...
  setAdvancedAudioOptions (options: AdvancedAudioOptions, sourceType: number = 0): number {
  ...
  protected getApiTypeFromSetAdvancedAudioOptions (options: AdvancedAudioOptions, sourceType: number = 0): string {
  ...
  destroyRendererByConfig (sourceType: VideoSourceType, channelId?: string, uid: number = 0): void {
  ...
  protected getApiTypeFromDestroyRendererByConfig (sourceType: VideoSourceType, channelId?: string, uid: number = 0): string {
