...
export class IScreenCaptureSourceListImpl implements IScreenCaptureSourceList {
  getCount (): number {
  ...
  getSourceInfo (index: number): ScreenCaptureSourceInfo {
    const apiType = 'ScreenCaptureSourceList_getSourceInfo'
    const jsonParams = {
      index,
      toJSON: () => {
        return { index }
  ...
  switch (event) {
    ...
    case 'onApiCallExecuted':
      if (handler.onApiCallExecuted !== undefined) {
        handler.onApiCallExecuted(jsonParams.err, jsonParams.api, jsonParams.result)
      }
      break
    ...
    case 'onAudioMixingStateChanged':
      if (handler.onAudioMixingStateChanged !== undefined) {
        handler.onAudioMixingStateChanged(jsonParams.state, jsonParams.errorCode)
      }
      break
    ...
    case 'onVideoPublishStateChanged':
      if (handler.onVideoPublishStateChanged !== undefined) {
        handler.onVideoPublishStateChanged(jsonParams.channel, jsonParams.oldState, jsonParams.newState, jsonParams.elapseSinceLastState)
      }
      break

    case 'onExtensionEvent':
      if (handler.onExtensionEvent !== undefined) {
        handler.onExtensionEvent(jsonParams.provider, jsonParams.ext_name, jsonParams.key, jsonParams.value)
      }
      break
    ...
    case 'onExtensionErrored':
      if (handler.onExtensionErrored !== undefined) {
        handler.onExtensionErrored(jsonParams.provider, jsonParams.ext_name, jsonParams.error, jsonParams.msg)
      }
      break
...
export class IVideoDeviceCollectionImpl implements IVideoDeviceCollection {
  getCount (): number {
  ...
  setDevice (deviceIdUTF8: string): number {
    const apiType = 'VideoDeviceCollection_setDevice'
    const jsonParams = {
      deviceIdUTF8,
      toJSON: () => {
        return { deviceIdUTF8 }
  ...
  getDevice (index: number): { deviceNameUTF8: string, deviceIdUTF8: string } {
    const apiType = 'VideoDeviceCollection_getDevice'
    const jsonParams = {
      index,
      toJSON: () => {
        return { index }
...
export class IVideoDeviceManagerImpl implements IVideoDeviceManager {
  enumerateVideoDevices (): IVideoDeviceCollection {
...
export function processIMetadataObserver (handler: IMetadataObserver, event: string, jsonParams: any) {
  switch (event) {
    case 'getMaxMetadataSize':
      if (handler.getMaxMetadataSize !== undefined) {
        handler.getMaxMetadataSize()
      }
      break

    case 'onReadyToSendMetadata':
      if (handler.onReadyToSendMetadata !== undefined) {
        handler.onReadyToSendMetadata(jsonParams.metadata, jsonParams.source_type)
      }
      break
...
export class IRtcEngineImpl implements IRtcEngine {
  ...
  joinChannel2 (token: string, channelId: string, uid: number, options: ChannelMediaOptions): number {
  ...
  leaveChannel2 (options: LeaveChannelOptions): number {
  ...
  setClientRole2 (role: ClientRoleType, options: ClientRoleOptions): number {
  ...
  startPreview2 (sourceType: VideoSourceType): number {
  ...
  stopPreview2 (sourceType: VideoSourceType): number {
  ...
  setAudioProfile2 (profile: AudioProfileType): number {
  ...
  startAudioRecording (filePath: string, quality: AudioRecordingQualityType): number {
  ...
  startAudioRecording2 (filePath: string, sampleRate: number, quality: AudioRecordingQualityType): number {
  ...
  startAudioRecording3 (config: AudioRecordingConfiguration): number {
  ...
  setLocalRenderMode2 (renderMode: RenderModeType): number {
  ...
  enableDualStreamMode2 (sourceType: VideoSourceType, enabled: boolean): number {
  ...
  enableDualStreamMode3 (sourceType: VideoSourceType, enabled: boolean, streamConfig: SimulcastStreamConfig): number {
  ...
  getScreenCaptureSources (thumbSize: number, iconSize: number, includeScreen: boolean): IScreenCaptureSourceList {
  ...
  startScreenCapture (mediaProjectionPermissionResultData: number[], captureParams: ScreenCaptureParameters): number {
  ...
  registerPacketObserver (observer: IPacketObserver): number {
    const apiType = 'RtcEngine_registerPacketObserver'
    const jsonParams = {
      observer,
      toJSON: () => {
        return {
  ...
  createDataStream2 (config: DataStreamConfig): number {
  ...
  sendStreamMessage (streamId: number, data: number[], length: number): number {
  ...
  addVideoWatermark2 (watermarkUrl: string, options: WatermarkOptions): number {
  ...
  joinChannelWithUserAccount2 (token: string, channelId: string, userAccount: string, options: ChannelMediaOptions): number {
  ...
  takeSnapshot (config: SnapShotConfig, callback: ISnapshotCallback): number {
...
export class IRtcEngineParameterImpl implements IRtcEngineParameter {
  release (): void {
  ...
  setBool (key: string, value: boolean): number {
    const apiType = 'RtcEngineParameter_setBool'
    const jsonParams = {
      key,
      value,
      toJSON: () => {
  ...
  setInt (key: string, value: number): number {
    const apiType = 'RtcEngineParameter_setInt'
    const jsonParams = {
      key,
      value,
      toJSON: () => {
  ...
  setUInt (key: string, value: number): number {
    const apiType = 'RtcEngineParameter_setUInt'
    const jsonParams = {
      key,
      value,
      toJSON: () => {
  ...
  setNumber (key: string, value: number): number {
    const apiType = 'RtcEngineParameter_setNumber'
    const jsonParams = {
      key,
      value,
      toJSON: () => {
  ...
  setString (key: string, value: string): number {
    const apiType = 'RtcEngineParameter_setString'
    const jsonParams = {
      key,
      value,
      toJSON: () => {
  ...
  setObject (key: string, value: string): number {
    const apiType = 'RtcEngineParameter_setObject'
    const jsonParams = {
      key,
      value,
      toJSON: () => {
  ...
  getBool (key: string): boolean {
    const apiType = 'RtcEngineParameter_getBool'
    const jsonParams = {
      key,
      toJSON: () => {
        return { key }
  ...
  getInt (key: string): number {
    const apiType = 'RtcEngineParameter_getInt'
    const jsonParams = {
      key,
      toJSON: () => {
        return { key }
  ...
  getUInt (key: string): number {
    const apiType = 'RtcEngineParameter_getUInt'
    const jsonParams = {
      key,
      toJSON: () => {
        return { key }
  ...
  getNumber (key: string): number {
    const apiType = 'RtcEngineParameter_getNumber'
    const jsonParams = {
      key,
      toJSON: () => {
        return { key }
  ...
  getString (key: string): string {
    const apiType = 'RtcEngineParameter_getString'
    const jsonParams = {
      key,
      toJSON: () => {
        return { key }
  ...
  getObject (key: string): string {
    const apiType = 'RtcEngineParameter_getObject'
    const jsonParams = {
      key,
      toJSON: () => {
        return { key }
  ...
  getArray (key: string): string {
    const apiType = 'RtcEngineParameter_getArray'
    const jsonParams = {
      key,
      toJSON: () => {
        return { key }
  ...
  setParameters (parameters: string): number {
    const apiType = 'RtcEngineParameter_setParameters'
    const jsonParams = {
      parameters,
      toJSON: () => {
        return { parameters }
  ...
  setProfile (profile: string, merge: boolean): number {
    const apiType = 'RtcEngineParameter_setProfile'
    const jsonParams = {
      profile,
      merge,
      toJSON: () => {
  ...
  convertPath (filePath: string, value: string): number {
    const apiType = 'RtcEngineParameter_convertPath'
    const jsonParams = {
      filePath,
      value,
      toJSON: () => {
...
export class AAudioDeviceManagerImpl implements AAudioDeviceManager {
}

export class AVideoDeviceManagerImpl implements AVideoDeviceManager {
}
