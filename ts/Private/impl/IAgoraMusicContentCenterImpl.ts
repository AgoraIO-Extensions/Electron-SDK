...
export function processIMusicContentCenterEventHandler (handler: IMusicContentCenterEventHandler, event: string, jsonParams: any) {
  switch (event) {
...
export class IMusicPlayerImpl extends IMediaPlayerImpl implements IMusicPlayer {
  ...
  protected getApiTypeFromOpenWithSongCode (songCode: number, startPos: number = 0): string {
...
cacheInfoSize,
  ...
  protected getApiTypeFromGetLyric (songCode: number, lyricType: number = 0): string {
