...
/**
 * The advanced options for the Local Access Point.
 */
export class AdvancedConfigInfo {
  /**
   * Custom log upload server. By default, the SDK uploads logs to Agora log server. You can modify the server where logs are uploaded through this parameter. See LogUploadServerInfo .
   */
...
export interface IRtcEngineEventHandler {
   ...
   *
   * @param connection The connection information. See RtcConnection for details.
   *
   */
  onEncryptionError?(
    connection: RtcConnection,
...
export abstract class IRtcEngine {
   ...
   * @param extension The name of the extension.
   * @param key The key of the extension.
   * @param type Source type of the extension. See MediaSourceType for details.
  ...
  /**
   * Updates the screen sharing parameters.
   * If the system audio is not captured when screen sharing is enabled, and then you want to update the parameter configuration and publish the system audio, you can refer to the following steps:Call this method, and set captureAudio to true.Call updateChannelMediaOptions , and set publishScreenCaptureAudio to true to publish the audio captured by the screen.
   *
