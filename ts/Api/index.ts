...
class AgoraRtcEngine extends EventEmitter {
  ...
  initEventHandler(): void {
    ...
    this.rtcEngine.onEvent('rtmpStreamingStateChanged', (url:string, state:number, code:number) => {
      fire('rtmpStreamingStateChanged', url, state, code)
    })
  ...
  videoSourceInitialize(appId: string, groupId?: string, bundleId?: string): number {
    return this.rtcEngine.videoSourceInitialize(appId, groupId, bundleId);
  }
