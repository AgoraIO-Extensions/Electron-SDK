...
declare interface AgoraRtcEngine {
  ...
  on(
    evt: 'streamMessage',
    cb: (uid: number, streamId: number, msg: Uint8Array, len: number) => void
  ): this;
...
class AgoraRtcChannel extends EventEmitter {
  ...
  initEventHandler(): void {
    ...
    this.rtcChannel.onEvent(
      'streamMessage',
      (uid: number, streamId: number, data: Uint8Array) => {
...
declare interface AgoraRtcChannel {
  ...
  on(
    evt: 'streamMessage',
    cb: (uid: number, streamId: number, data: Uint8Array) => void
  ): this;
