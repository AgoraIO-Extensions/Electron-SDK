...
//   | 14 // 14: A timeout occurs for the keep-alive of the connection between the SDK and the server.
//   | 15 // 15: The SDK has rejoined the channel successfully.
//   | 16 // 16: The connection between the SDK and the server is lost.
//   | 17 // 17: The change of connection state is caused by echo test.
//   | 18; // 18: The local IP Address is changed by user.
