...
#define MEDIA_PLAYER_ON_PRELOAD_EVENT "onPreloadEvent"
...
#define MEDIA_PLAYER_MAKE_JS_CALL_5(ev, type1, param1, type2, param2, type3, param3, type4, param4, type5, param5) \
        ...
        class NodeMediaPlayerObserver : public IMediaPlayerObserver {
        ...
        public:
            ...
            virtual void onPositionChanged(const int64_t position_ms) override;
            
            virtual void onPlayerEvent(media::base::MEDIA_PLAYER_EVENT event) override;
            virtual void onMetadata(media::base::MEDIA_PLAYER_METADATA_TYPE type, 
