    ...
    namespace rtc {
        ...
        void NodeRtcEngine::Init(Local<Object>& module)
        {
            ...
            BEGIN_PROPERTY_DEFINE(NodeRtcEngine, createInstance, 5)
                ...
                PROPERTY_METHOD_DEFINE(setBeautyEffectFaceUnityOptions);
                PROPERTY_METHOD_DEFINE(releaseFaceUnity);
...
#define NODE_SET_OBJ_WINDOWINFO_DATA(isolate, obj, name, info) \
    { \
        ...
        NAPI_API_DEFINE(NodeRtcEngine, setBeautyEffectFaceUnityOptions)
        {
            LOG_ENTER;
            do {
                int result = -1;
        ...
        NAPI_API_DEFINE(NodeRtcEngine, releaseFaceUnity)
        {
            LOG_ENTER;
            int result = -1;
            do {
