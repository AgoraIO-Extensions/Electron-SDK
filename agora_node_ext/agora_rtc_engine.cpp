...
void setChannelMediaOptions(ChannelMediaOptions &option,std::string &token, const Nan::FunctionCallbackInfo<Value>& args, const Local<Object>& value){
  Isolate* isolate = args.GetIsolate();
  napi_status status = napi_invalid_arg;

  //publishCameraTrack;//1
  bool publishCameraTrack = false;
  status = napi_get_object_property_bool_(isolate, value, "publishCameraTrack", publishCameraTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishSecondaryCameraTrack", publishSecondaryCameraTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishTertiaryCameraTrack", publishTertiaryCameraTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishQuaternaryCameraTrack", publishQuaternaryCameraTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishAudioTrack", publishAudioTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishScreenTrack", publishScreenTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishSecondaryScreenTrack", publishSecondaryScreenTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishCustomAudioTrack", publishCustomAudioTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_int32_(isolate, value, "publishCustomAudioSourceId", publishCustomAudioSourceId);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishCustomAudioTrackEnableAec", publishCustomAudioTrackEnableAec);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishDirectCustomAudioTrack", publishDirectCustomAudioTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishCustomAudioTrackAec", publishCustomAudioTrackAec);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishCustomVideoTrack", publishCustomVideoTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishEncodedVideoTrack", publishEncodedVideoTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishMediaPlayerAudioTrack", publishMediaPlayerAudioTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishMediaPlayerVideoTrack", publishMediaPlayerVideoTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishTrancodedVideoTrack", publishTrancodedVideoTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "autoSubscribeAudio", autoSubscribeAudio);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "autoSubscribeVideo", autoSubscribeVideo);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "enableAudioRecordingOrPlayout", enableAudioRecordingOrPlayout);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_int32_(isolate, value, "publishMediaPlayerId", publishMediaPlayerId);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_int32_(isolate, value, "clientRoleType", clientRoleType);
  if (status == napi_ok)
  {
  ...
  status = napi_get_object_property_int32_(isolate, value, "audienceLatencyLevel", audienceLatencyLevel);
  if (status == napi_ok) {
    option.audienceLatencyLevel = (AUDIENCE_LATENCY_LEVEL_TYPE)audienceLatencyLevel;
  }

  //defaultVideoStreamType;//24
  int32_t defaultVideoStreamType = 0;
  status = napi_get_object_property_int32_(isolate, value, "defaultVideoStreamType", defaultVideoStreamType);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_int32_(isolate, value, "channelProfile", channelProfile);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_int32_(isolate, value, "audioDelayMs", audioDelayMs);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_int32_(isolate, value, "mediaPlayerAudioDelayMs", mediaPlayerAudioDelayMs);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_nodestring_(isolate, value, "token", tokenNodeString);
  ...
  status = napi_get_object_property_bool_(isolate, value, "enableBuiltInMediaEncryption", enableBuiltInMediaEncryption);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "publishRhythmPlayerTrack", publishRhythmPlayerTrack);
  if (status == napi_ok) {
  ...
  status = napi_get_object_property_bool_(isolate, value, "isInteractiveAudience", isInteractiveAudience);
  if (status == napi_ok) {
    option.isInteractiveAudience = isInteractiveAudience;
  }

  Local<Object> encodedVideoTrackOptionObj;
  status = napi_get_object_property_object_(isolate, value, "encodedVideoTrackOption", encodedVideoTrackOptionObj);
  if (status == napi_ok && encodedVideoTrackOptionObj->IsObject()) {
    ...
    int32_t ccMode = 0;
    status = napi_get_object_property_int32_(isolate, encodedVideoTrackOptionObj, "ccMode", ccMode);
    if (status == napi_ok) {
      option.encodedVideoTrackOption.ccMode = (TCcMode)ccMode;
    }

    int32_t codecType = 0;
    status = napi_get_object_property_int32_(isolate, encodedVideoTrackOptionObj, "codecType", codecType);
    if (status == napi_ok) {
      option.encodedVideoTrackOption.codecType = (VIDEO_CODEC_TYPE)codecType;
    }

    int32_t targetBitrate = 0;
    status = napi_get_object_property_int32_(isolate, encodedVideoTrackOptionObj, "targetBitrate", targetBitrate);
    if (status == napi_ok) {
  ...
  status = napi_get_object_property_object_(isolate, value, "audioOptionsAdvanced", audioOptionsAdvancedObj);
  if (status == napi_ok && audioOptionsAdvancedObj->IsObject()) {
   ...
   // Optional<bool> enable_aec_external_loopback_;
    ...
    status = napi_get_object_property_bool_(isolate, audioOptionsAdvancedObj, "enable_aec_external_custom_", enable_aec_external_custom_);
    if (status == napi_ok) {
      option.audioOptionsAdvanced.enable_aec_external_custom_ = enable_aec_external_custom_;
    }

    bool enable_aec_external_loopback_ = 0;
    status = napi_get_object_property_bool_(isolate, audioOptionsAdvancedObj, "enable_aec_external_loopback_", enable_aec_external_loopback_);
    if (status == napi_ok) {
      option.audioOptionsAdvanced.enable_aec_external_loopback_ = enable_aec_external_loopback_;
    }
  }
...
NAPI_API_DEFINE_WRAPPER_PARAM_7(playEffect, int32, nodestring, int32, double,
                                double, int32, bool);
...
NAPI_API_DEFINE(NodeRtcEngine, startLocalVideoTranscoder) {
  ...
  do {
    ...
    CHECK_NAPI_STATUS(pEngine, status);
    status = napi_get_object_property_uint32_(isolate, obj, "streamCount",
                                              streamCount);
    CHECK_NAPI_STATUS(pEngine, status);
    ...
    if (streamCount > 0) {
      ...
      Local<Name> keyName =
          Nan::New<String>("videoInputStreams").ToLocalChecked();
      Local<Value> videoInputStreamsObj =
          obj->Get(isolate->GetCurrentContext(), keyName).ToLocalChecked();
      if (videoInputStreamsObj->IsNullOrUndefined() ||
          !videoInputStreamsObj->IsArray()) {
      ...
      for (uint32 i = 0; i < streamCount; i++) {
        Local<Value> value =
            videoInputStreamsValue->Get(context, i).ToLocalChecked();
        ...
        int sourceType;
        napi_get_object_property_int32_(isolate, videoInputStreamObj,
                                        "sourceType", sourceType);
        CHECK_NAPI_STATUS(pEngine, status);
        videoInputStreams[i].sourceType =
            (agora::media::MEDIA_SOURCE_TYPE)sourceType;
        napi_get_object_property_uint32_(isolate, videoInputStreamObj,
                                         "remoteUserUid",
                                         videoInputStreams[i].remoteUserUid);
        napi_get_object_property_nodestring_(isolate, videoInputStreamObj,
        ...
        CHECK_NAPI_STATUS(pEngine, status);
        napi_get_object_property_double_(isolate, videoInputStreamObj, "width",
                                         width);
        CHECK_NAPI_STATUS(pEngine, status);
        napi_get_object_property_double_(isolate, videoInputStreamObj, "height",
                                         height);
        CHECK_NAPI_STATUS(pEngine, status);
        ...
        napi_get_object_property_int32_(isolate, videoInputStreamObj, "zOrder",
                                        videoInputStreams[i].zOrder);
        napi_get_object_property_double_(isolate, videoInputStreamObj, "alpha",
                                         videoInputStreams[i].alpha);
    ...
    Local<Name> keyName =
        Nan::New<String>("videoOutputConfiguration").ToLocalChecked();
    Local<Value> videoOutputConfigurationValue =
        obj->Get(isolate->GetCurrentContext(), keyName).ToLocalChecked();
    if (!videoOutputConfigurationValue->IsNullOrUndefined()) {
      Local<Object> videoOutputConfigurationObj;
      status = napi_get_value_object_(isolate, videoOutputConfigurationValue,
                                      videoOutputConfigurationObj);
      CHECK_NAPI_STATUS(pEngine, status);
      status = napi_get_object_property_int32_(
          isolate, videoOutputConfigurationObj, "width", dimensions.width);
      CHECK_NAPI_STATUS(pEngine, status);
      status = napi_get_object_property_int32_(
          isolate, videoOutputConfigurationObj, "height", dimensions.height);
      CHECK_NAPI_STATUS(pEngine, status);
      config.dimensions = dimensions;
      status = napi_get_object_property_int32_(
          isolate, videoOutputConfigurationObj, "bitrate", config.bitrate);
      CHECK_NAPI_STATUS(pEngine, status);
      status =
          napi_get_object_property_int32_(isolate, videoOutputConfigurationObj,
      ...
      status = napi_get_object_property_int32_(
          isolate, videoOutputConfigurationObj, "frameRate", frameRateVal);
      CHECK_NAPI_STATUS(pEngine, status);
      config.frameRate = (FRAME_RATE)frameRateVal;
      int orientationModeVal;
      ORIENTATION_MODE orientationMode;
      status = napi_get_object_property_int32_(
          isolate, videoOutputConfigurationObj, "orientationMode",
          orientationModeVal);
      CHECK_NAPI_STATUS(pEngine, status);
      ...
      status = napi_get_object_property_int32_(
          isolate, videoOutputConfigurationObj, "degradationPreference",
          degradationPrefValue);
      CHECK_NAPI_STATUS(pEngine, status);
...
NAPI_API_DEFINE(NodeRtcEngine, updateLocalTranscoderConfiguration) {
  ...
  do {
    ...
    localTranscoderConfiguration.videoOutputConfiguration = config;
    result = pEngine->m_engine->updateLocalTranscoderConfiguration(
        localTranscoderConfiguration);
  } while (false);
  if (videoInputStreams) {
    delete[] videoInputStreams;
...
NAPI_API_DEFINE(NodeRtcEngine, setLiveTranscoding) {
  ...
  do {
    ...
    status = napi_get_object_property_int32_(isolate, obj, "height",
                                             transcoding.height);
    CHECK_NAPI_STATUS(pEngine, status);
    status = napi_get_object_property_int32_(isolate, obj, "videoBitrate",
                                             transcoding.videoBitrate);
    CHECK_NAPI_STATUS(pEngine, status);
    status = napi_get_object_property_int32_(isolate, obj, "videoFrameRate",
                                             transcoding.videoFramerate);
    CHECK_NAPI_STATUS(pEngine, status);
    status = napi_get_object_property_bool_(isolate, obj, "lowLatency",
                                            transcoding.lowLatency);
    CHECK_NAPI_STATUS(pEngine, status);
    status = napi_get_object_property_int32_(isolate, obj, "videoGop",
                                             transcoding.videoGop);
    CHECK_NAPI_STATUS(pEngine, status);

    status = napi_get_object_property_int32_(isolate, obj, "videoCodecProfile",
                                             videoCodecProfile);
    CHECK_NAPI_STATUS(pEngine, status);
    transcoding.videoCodecProfile = (VIDEO_CODEC_PROFILE_TYPE)videoCodecProfile;

    status = napi_get_object_property_uint32_(isolate, obj, "backgroundColor",
                                              transcoding.backgroundColor);
    CHECK_NAPI_STATUS(pEngine, status);

    status = napi_get_object_property_uint32_(isolate, obj, "userCount",
                                              transcoding.userCount);
    CHECK_NAPI_STATUS(pEngine, status);

    status = napi_get_object_property_int32_(isolate, obj, "audioSampleRate",
                                             audioSampleRateType);
    transcoding.audioSampleRate = (AUDIO_SAMPLE_RATE_TYPE)audioSampleRateType;
    CHECK_NAPI_STATUS(pEngine, status);

    status = napi_get_object_property_int32_(isolate, obj, "audioBitrate",
                                             transcoding.audioBitrate);
    CHECK_NAPI_STATUS(pEngine, status);

    status = napi_get_object_property_int32_(isolate, obj, "audioChannels",
                                             transcoding.audioChannels);
    CHECK_NAPI_STATUS(pEngine, status);

    status = napi_get_object_property_nodestring_(
        isolate, obj, "transcodingExtraInfo", transcodingExtraInfo);
    CHECK_NAPI_STATUS(pEngine, status);
    ...
    if (!wmValue->IsNullOrUndefined()) {
      ...
      status =
          napi_get_object_property_nodestring_(isolate, objWm, "url", wmurl);
      CHECK_NAPI_STATUS(pEngine, status);
      wkImage.url = wmurl;
      ...
      status = napi_get_object_property_int32_(isolate, objWm, "width",
                                               wkImage.width);
      CHECK_NAPI_STATUS(pEngine, status);

      status = napi_get_object_property_int32_(isolate, objWm, "height",
                                               wkImage.height);
      CHECK_NAPI_STATUS(pEngine, status);
    ...
    if (!bgValue->IsNullOrUndefined()) {
      ...
      status =
          napi_get_object_property_nodestring_(isolate, objBg, "url", bgurl);
      CHECK_NAPI_STATUS(pEngine, status);
      bgImage.url = bgurl;
      ...
      status = napi_get_object_property_int32_(isolate, objBg, "width",
                                               bgImage.width);
      CHECK_NAPI_STATUS(pEngine, status);

      status = napi_get_object_property_int32_(isolate, objBg, "height",
                                               bgImage.height);
      CHECK_NAPI_STATUS(pEngine, status);
    ...
    if (transcoding.userCount > 0) {
      ...
      Local<Name> keyName =
          Nan::New<String>("transcodingUsers").ToLocalChecked();
      ...
      for (uint32 i = 0; i < transcoding.userCount; i++) {
        ...
        napi_get_object_property_int32_(isolate, userObj, "width",
                                        users[i].width);
        napi_get_object_property_int32_(isolate, userObj, "height",
                                        users[i].height);
        napi_get_object_property_int32_(isolate, userObj, "zOrder",
                                        users[i].zOrder);
        napi_get_object_property_double_(isolate, userObj, "alpha",
                                         users[i].alpha);
        napi_get_object_property_int32_(isolate, userObj, "audioChannel",
...
//             status = napi_get_object_property_int32_(isolate, obj,
//             "lighteningContrastLevel", contrast_value);
//             CHECK_NAPI_STATUS(pEngine, status);

//             switch(contrast_value) {
//                 case 0:
//                     opts.lighteningContrastLevel =
//                     BeautyOptions::LIGHTENING_CONTRAST_LOW; break;
//                 case 1:
//                     opts.lighteningContrastLevel =
//                     BeautyOptions::LIGHTENING_CONTRAST_NORMAL; break;
//                 case 2:
//                     opts.lighteningContrastLevel =
//                     BeautyOptions::LIGHTENING_CONTRAST_HIGH; break;
//                 default:
//                     status = napi_invalid_arg;
//                     break;
//             }
...
//             status = napi_get_object_property_double_(isolate, obj,
//             "lighteningLevel", lightening); CHECK_NAPI_STATUS(pEngine,
//             status); status = napi_get_object_property_double_(isolate, obj,
//             "smoothnessLevel", smoothness); CHECK_NAPI_STATUS(pEngine,
//             status); status = napi_get_object_property_double_(isolate, obj,
//             "rednessLevel", redness); CHECK_NAPI_STATUS(pEngine, status);
...
//         status = napi_get_object_property_int32_(isolate, obj, "preference",
//         preference); CHECK_NAPI_STATUS(pEngine, status);
...
NAPI_API_DEFINE(NodeRtcEngine, setLocalVoiceReverb) {
  ...
  do {
    ...
    status = napi_get_value_int32_(args[1], value);
    CHECK_NAPI_STATUS(pEngine, status);
    result = pEngine->m_engine->setLocalVoiceReverb(
        (AUDIO_REVERB_TYPE)reverbKey, value);
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
}
...
NAPI_API_DEFINE(NodeRtcEngine, initialize) {
  ...
  do {
    ...
    if (status == napi_ok) {
      ...
      status = napi_get_object_property_nodestring_(isolate, logConfig,
                                                    "filePath", filePath);
      CHECK_NAPI_STATUS(pEngine, status);
      logConfigStrut.filePath = filePath;

      status = napi_get_object_property_uint32_(
          isolate, logConfig, "fileSizeInKB", logConfigStrut.fileSizeInKB);
      CHECK_NAPI_STATUS(pEngine, status);
      uint32_t logLevel = 0x0001;
      status = napi_get_object_property_uint32_(isolate, logConfig, "level",
                                                logLevel);
    ...
    pEngine->getRtcEngine()->queryInterface(
    ...
    if (pMediaEngine && pEngine->m_nodeVideoFrameObserver.get()) {
      pMediaEngine->registerVideoFrameObserver(
          pEngine->m_nodeVideoFrameObserver.get());
      result = 0;
    }
...
//         CHECK_NAPI_STATUS(pEngine, status);
//         result =
//         pEngine->m_engine->setVideoProfile(VIDEO_PROFILE_TYPE(profile),
//         swapWandH);
//     } while (false);
//     napi_set_int_result(args, result);
//     LOG_LEAVE;
...
NAPI_API_DEFINE(NodeRtcEngine, setVideoEncoderConfiguration) {
  ...
  do {
    ...
    // config.minFrameRate); CHECK_NAPI_STATUS(pEngine, status);
...
NAPI_API_DEFINE(NodeRtcEngine, subscribe) {
  ...
  do {
    ...
    if (renderType < NODE_RENDER_TYPE_LOCAL ||
        renderType > NODE_RENDER_TYPE_TRANSCODED) {
    ...
    if (pTransporter) {
      ...
      pTransporter->subscribe((NodeRenderType)renderType, uid, channelStr,
                              deviceId);
      result = 0;
    }
  } while (false);
...
NAPI_API_DEFINE(NodeRtcEngine, unsubscribe) {
  ...
  do {
    ...
    if (pTransporter) {
      ...
      pTransporter->unsubscribe((NodeRenderType)renderType, uid, channelStr,
                                deviceId);
      result = 0;
    }
  } while (false);
...
NAPI_API_DEFINE(NodeRtcEngine, setRemoteVideoStreamType) {
  ...
  do {
    ...
    result = pEngine->m_engine->setRemoteVideoStreamType(
        uid, VIDEO_STREAM_TYPE(streamType));
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
}
...
NAPI_API_DEFINE(NodeRtcEngine, startAudioRecording) {
  ...
  do {
    ...
    result = pEngine->m_engine->startAudioRecording(
        filePath, AUDIO_RECORDING_QUALITY_TYPE(quality));
  } while (false);
  napi_set_int_result(args, result);
...
NAPI_API_DEFINE(NodeRtcEngine, startAudioRecording2) {
  ...
  do {
    ...
    napi_get_param_3(args, nodestring, filePath, int32, sampleRate, int32,
                     quality);

    result = pEngine->m_engine->startAudioRecording(
        filePath, sampleRate, AUDIO_RECORDING_QUALITY_TYPE(quality));
  } while (false);
  napi_set_int_result(args, result);
...
(int)AUDIENCE_LATENCY_LEVEL_ULTRA_LOW_LATENCY;

            status = napi_get_object_property_int32_(isolate, obj,
"audienceLatencyLevel", audienceLatencyLevel); CHECK_NAPI_STATUS(pEngine,
status);

            switch(audienceLatencyLevel) {
                case 1:
                    opts.audienceLatencyLevel =
AUDIENCE_LATENCY_LEVEL_LOW_LATENCY; break; case 2: opts.audienceLatencyLevel =
AUDIENCE_LATENCY_LEVEL_ULTRA_LOW_LATENCY; break; default: status =
napi_invalid_arg; break;
            }
            CHECK_NAPI_STATUS(pEngine, status);
        }
...
//             Local<Object> config;
//             status = napi_get_value_object_(isolate, args[0], config);
//             CHECK_NAPI_STATUS(pEngine, status);
...
//         // napi_get_object_property_nodestring_(isolate, videoInputStreamObj,
//         "imageUrl", imageUrlList[i]);
//             AudioFileRecordingConfig audioFileRecordingConfig;
//             NodeString filePath;
//             napi_get_object_property_nodestring_(isolate, )

//             result = pEngine->m_engine->startAudioRecording(filePath,
//             sampleRate, AUDIO_RECORDING_QUALITY_TYPE(quality));
//         } while (false);
//         napi_set_int_result(args, result);
...
NAPI_API_DEFINE(NodeRtcEngine, startAudioMixing) {
  ...
  do {
    ...
    napi_get_native_this(args, pEngine);
    CHECK_NATIVE_THIS(pEngine);
    napi_get_param_4(args, nodestring, filepath, bool, loopback, bool, replace,
                     int32, cycle);
    CHECK_NAPI_STATUS(pEngine, status);
    result =
        pEngine->m_engine->startAudioMixing(filepath, loopback, replace, cycle);
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
}
...
NAPI_API_DEFINE(NodeRtcEngine, setMixedAudioFrameParameters) {
  ...
  do {
    ...
    napi_get_native_this(args, pEngine);
    CHECK_NATIVE_THIS(pEngine);
    napi_get_param_3(args, int32, sampleRate, int32, channel, int32,
                     samplesPerCall);
    CHECK_NAPI_STATUS(pEngine, status);

    result = pEngine->m_engine->setMixedAudioFrameParameters(
...
//         napi_get_native_this(args, pEngine);
//         CHECK_NATIVE_THIS(pEngine);
//         napi_get_param_3(args, bool, fullband, bool, stereo, bool,
//         fullBitrate); CHECK_NAPI_STATUS(pEngine, status);

//         RtcEngineParameters rep(pEngine->m_engine);
//         result = rep.setHighQualityAudioParameters(fullband, stereo,
//         fullBitrate);
//     } while (false);
//     napi_set_int_result(args, result);
//     LOG_LEAVE;
...
//                 status = napi_get_object_property_int32_(isolate, rect,
//                 "top", top); CHECK_NAPI_STATUS(pEngine, status); status =
//                 napi_get_object_property_int32_(isolate, rect, "left", left);
//                 CHECK_NAPI_STATUS(pEngine, status);
//                 status = napi_get_object_property_int32_(isolate, rect,
//                 "bottom", bottom); CHECK_NAPI_STATUS(pEngine, status); status
//                 = napi_get_object_property_int32_(isolate, rect, "right",
//                 right); CHECK_NAPI_STATUS(pEngine, status);

//                 status = napi_get_value_int32_(args[3], bitrate);
//                 CHECK_NAPI_STATUS(pEngine, status);

//                 Rect region(top, left, bottom, right);
//                 result = pEngine->m_engine->startScreenCapture(windowId,
//                 captureFreq, &region, bitrate);
//             } while (false);
//             napi_set_int_result(args, result);
//             LOG_LEAVE;
//         }
...
NAPI_API_DEFINE(NodeRtcEngine, enablePlugin) {
  ...
  do {
    ...
    if (result != 0) {
      LOG_ERROR("Error :%s, :%d, plugin: \"%s\"  IAVFramePlugin::enablePlugin "
                "return non-zero %d\n",
...
//         result = pEngine->m_engine->registerLocalUserAccount(appId,
//         userAccount);
//     } while (false);
...
//         result = pEngine->m_engine->joinChannelWithUserAccount(token,
//         channel, userAccount);
//     } while (false);
//     napi_set_array_result(args, result);
//     LOG_LEAVE;
...
//         napi_status status = napi_get_value_nodestring_(args[0],
//         userAccount); CHECK_NAPI_STATUS(pEngine, status);

//         result = pEngine->m_engine->getUserInfoByUserAccount(userAccount,
//         &userInfo); Local<v8::Object> obj = Object::New(isolate);
...
//         userInfo.userAccount); Local<Value> propName =
//         String::NewFromUtf8(isolate, "userInfo",
//         NewStringType::kInternalized).ToLocalChecked(); obj->Set(context,
//         propName, userObj); args.GetReturnValue().Set(obj);
//     } while (false);
//     LOG_LEAVE;
// }
...
NAPI_API_DEFINE(NodeRtcEngine, startScreenCaptureByWindow) {
  ...
  do {
    ...
    result = pEngine->m_engine->startScreenCaptureByWindowId(
        reinterpret_cast<agora::view_t>(windowId), regionRect, captureParams);
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
}
...
NAPI_API_DEFINE(NodeRtcEngine, joinChannelEx) {
  ...
  do {
    ...
    status = napi_get_object_property_bool_(isolate, optionObj,
                                            ...
                                            publishSecondaryCameraTrack);
    channelMediaOptions.publishSecondaryCameraTrack =
        publishSecondaryCameraTrack;
    bool publishAudioTrack = false;
    status = napi_get_object_property_bool_(
    ...
    status = napi_get_object_property_bool_(isolate, optionObj,
                                            ...
                                            publishSecondaryScreenTrack);
    channelMediaOptions.publishSecondaryScreenTrack =
        publishSecondaryScreenTrack;
    bool publishCustomAudioTrack = false;
    status = napi_get_object_property_bool_(
    ...
    agora::rtc::IRtcEngineEx *engineEx =
        (agora::rtc::IRtcEngineEx *)pEngine->m_engine;
    result = engineEx->joinChannelEx(token, rtcConnection, channelMediaOptions,
                                     nullptr);
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
...
NAPI_API_DEFINE(NodeRtcEngine, joinChannel2) {
  ...
  do {
    ...
    result = pEngine->m_engine->joinChannel(token, channelId, uid,
                                            channelMediaOptions);
...
NAPI_API_DEFINE(NodeRtcEngine, setCameraDeviceOrientation) {
  ...
  do {
    ...
    result = pEngine->m_engine->setCameraDeviceOrientation(
        (VIDEO_SOURCE_TYPE)type, (VIDEO_ORIENTATION)orientation);
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
}
...
NAPI_API_DEFINE(NodeRtcEngine, startPrimaryScreenCapture) {
  ...
  do {
    ...
    key = "params";
    status = napi_get_object_property_object_(isolate, obj, key,
                                              screenCaptureParameterObj);
    if (status == napi_ok) {
      VideoDimensions dimensions;
      key = "width";
      status = napi_get_object_property_int32_(
          isolate, screenCaptureParameterObj, key, dimensions.width);
      CHECK_NAPI_STATUS_STR(pEngine, status, key);
      key = "height";
      status = napi_get_object_property_int32_(
          isolate, screenCaptureParameterObj, key, dimensions.height);
      CHECK_NAPI_STATUS_STR(pEngine, status, key);
      key = "frameRate";
      status = napi_get_object_property_int32_(
          isolate, screenCaptureParameterObj, key, params.frameRate);
      CHECK_NAPI_STATUS_STR(pEngine, status, key);
      key = "bitrate";
      status = napi_get_object_property_int32_(
          isolate, screenCaptureParameterObj, key, params.bitrate);
      CHECK_NAPI_STATUS_STR(pEngine, status, key);
...
NAPI_API_DEFINE(NodeRtcEngine, getExtensionProperty) {
  ...
  do {
    ...
    result = pEngine->m_engine->getExtensionProperty(
        provider_name, extension_name, key, json_value, buf_len,
        (agora::media::MEDIA_SOURCE_TYPE)type);
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
...
NAPI_API_DEFINE(NodeRtcEngine, setBeautyEffectOptions) {
  ...
  do {
    ...
    status = napi_get_object_property_int32_(
        isolate, obj, "lighteningContrastLevel", lighteningContrastLevel);
    CHECK_NAPI_STATUS(pEngine, status);
...
NAPI_API_DEFINE(NodeRtcEngine, setScreenCaptureOrientation) {
  ...
  do {
    ...
    CHECK_NAPI_STATUS(pEngine, status);
    result = pEngine->m_engine->setScreenCaptureOrientation(
        (VIDEO_SOURCE_TYPE)type, (VIDEO_ORIENTATION)orientation);
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
...
NAPI_API_DEFINE(NodeRtcEngine, setExtensionProviderProperty) {
  ...
  do {
    ...
    result = pEngine->m_engine->setExtensionProviderProperty(provider_name, key,
                                                             json_value);
  } while (false);
  napi_set_int_result(args, result);
  LOG_LEAVE;
