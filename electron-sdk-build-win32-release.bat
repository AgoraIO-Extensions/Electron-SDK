...
C:\SignatureTools\SignatureTools\signtool.exe sign /f "C:\SignatureTools\SignatureTools\agora.pfx" /p "31169323" /t "http://timestamp.comodoca.com/authenticode" "build/Release/VideoSource.exe"
C:\SignatureTools\SignatureTools\signtool.exe sign /f "C:\SignatureTools\SignatureTools\agora.pfx" /p "31169323" /t "http://timestamp.comodoca.com/authenticode" "build/Release/agora_node_ext.node"
