...
enum AgoraIpcMsg {
  ...
  AGORA_IPC_SET_CLOUD_PROXY,
  AGORA_IPC_MUTE_LOCAL_VIDEO_STREAM,
  AGORA_IPC_SET_SCREEN_CAPTURE_SCENARIO,
};
...
#define IPC_STRING_PARTTERN std::string("---IPC_ARRAY_DATA_PATTERN---")
/**
...
struct ChannelProfileCmd {
  ...
  ChannelProfileCmd()
      : profile(agora::rtc::CHANNEL_PROFILE_LIVE_BROADCASTING), permissionKey{
                                                                    0} {}
};
...
struct LoopbackRecordingCmd {
  ...
  LoopbackRecordingCmd() : enabled(false), deviceName{NULL} {}
};
...
struct EncryptionConfigCmd {
 public:
  ...
  EncryptionConfigCmd()
      : encryptionMode(agora::rtc::ENCRYPTION_MODE::AES_128_XTS), encryptionKey{
                                                                      '\0'} {}
