...
enum AgoraIpcMsg
{
    ...
    AGORA_IPC_VIDEO_SOURCE_SET_VIDEO_DEVICE,
    AGORA_IPC_VIDEO_SOURCE_ENABLE_VIDEO,
    AGORA_IPC_VIDEO_SOURCE_DISABLE_VIDEO,
    AGORA_IPC_VIDEO_SOURCE_DISABLE_AUDIO,
    AGORA_IPC_VIDEO_SOURCE_ENABLE_LOCAL_VIDEO,
    AGORA_IPC_VIDEO_SOURCE_ENABLE_LOCAL_AUDIO,
    AGORA_IPC_VIDEO_SOURCE_SET_VIDEO_ENCODER_CONFIGURATION,
    AGORA_IPC_VIDEO_SOURCE_SET_CLIENT_ROLE,
