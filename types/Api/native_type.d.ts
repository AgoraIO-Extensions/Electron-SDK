export declare type AgoraNetworkQuality = 0 | 1 | 2 | 3 | 4 | 5 | 6;
...
export declare type MediaDeviceType = -1 | 0 | 1 | 2 | 3 | 4;
...
export declare enum CaptureOutPreference {
...
export declare enum VIDEO_PROFILE_TYPE {
