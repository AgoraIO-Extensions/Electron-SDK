...
int AgoraVideoSourceTransporter::deliverFrame_I420(const agora::media::IVideoFrame& videoFrame, int rotation, bool mirrored)
{
    ...
    //     (uint8_t*)y, destWidth, (uint8_t*)u, destWidthU, (uint8_t*)v, destWidthU, destWidth, destHeight, kFilterNone);
    ...
    {
        I420Scale(planeY, stride0, planeU, strideU, planeV, strideV, videoFrame.width(), videoFrame.height(), (uint8_t*)y, dest_stride, (uint8_t*)u, width2, (uint8_t*)v, width2, width, height, kFilterNone);
    }
