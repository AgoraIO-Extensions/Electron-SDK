...
#if defined(_WIN32)
void AgoraVideoSourceEventHandler::onScreenCaptureInfoUpdated(agora::rtc::ScreenCaptureInfo& info) {
  m_videoSource.notifyScreenCaptureInfoUpdated(info.cardType, (int)info.errCode);
}
#endif
