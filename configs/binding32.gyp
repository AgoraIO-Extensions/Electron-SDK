    ...
    'targets': [
    {
        ...
        'conditions': [
            ...
            'OS=="win"',
            {
                ...
                "copies": [
                    {
                        "files": [ "./resources/bugsplat/VideoSourceDump.dll" ],
                        "destination": "./build/Release"
                    },
                    {
                        "files": [ "./resources/bugsplat/BugSplat.dll" ],
                        "destination": "./build/Release"
                    },
                    {
                        "files": [ "./resources/bugsplat/BugSplatRc.dll" ],
                        "destination": "./build/Release"
                    },
                    {
                        "files": [ "./resources/bugsplat/BsSndRpt.exe" ],
                        "destination": "./build/Release"
                    }
                ]
            }
