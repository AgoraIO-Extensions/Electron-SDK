...
module.exports = ({
  ...
  if (['11.0.0', '10.2.0', '9.0.0', '7.3.3', '7.1.2', '6.1.7', '5.0.8', '4.2.8', '3.0.6', '1.8.3'].indexOf(electronVersion) === -1) {
    throw new Error('Prebuilt addon only supported electron version 11.0.0 10.2.0 9.0.0 7.3.3 7.1.2 6.1.7 5.0.8 4.2.8 3.0.6 1.8.3')
  }
