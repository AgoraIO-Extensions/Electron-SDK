...
module.exports = ({
  ...
  if (['7.1.2', '6.1.7', '5.0.8', '4.2.8', '3.0.6', '1.8.3','11.1.1'].indexOf(electronVersion) === -1) {
    throw new Error('Prebuilt addon only supported electron version 7.1.2, 6.1.7, 5.0.8, 4.2.8, 3.0.6, 1.8.3, 11.1.1')
  }
