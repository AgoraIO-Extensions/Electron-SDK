...
const install = () => {
  ...
  if (platform === 'mac') {
    shell.echo(chalk.blue('Building AgoraRTC SDK for mac, this will cost a little time...'));
    ...
    shell.echo(
      chalk.blue('Building AgoraRTC SDK for windows 32bit, this will cost a little time...')
    );
    if (
