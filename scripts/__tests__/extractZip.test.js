...
const SYMLINK_LEXICAL_BYPASS_ZIP_FIXTURE = Buffer.from(
  '',
  'base64'
);
...
describe('extractZip', () => {
  ...
  test('rejects escaping links nested under earlier symbolic links', async () => {
    await expect(
      extractZip(SYMLINK_LEXICAL_BYPASS_ZIP_FIXTURE, output)
